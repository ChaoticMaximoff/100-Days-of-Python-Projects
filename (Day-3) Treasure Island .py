...
if answer.lower() == "left":
  answer = input("You're at a lake. What do you want to do? Type \"swim\" or \"wait\"\n")
  
  if answer.lower() == "wait":
    answer = input("Three doors appear in front of you. Which door do you want to open? Type \"red\" or \"yellow\" or \"blue\"\n")
